...
Отчет: `../Отчеты/ЛР2/Отчет ЛР2 Git.docx`.
...
- `screenshots/` — 19 исходных PNG: подтверждения каждого пункта и окна KDiff3 до и после разрешения конфликта.
- `protocol/` — команды, фактический вывод, время выполнения и коды завершения. HTML — страницы протокола, снимки которых вставлены в отчет; TXT и JSON содержат исходные данные.
